...
if redis:get(max.."getidstatus"..msg.chat_id_) == "Photo" then
	if data.photos_[0] then 
		...
		sendPhoto(msg.chat_id_,msg.id_,data.photos_[0].sizes_[1].photo_.persistent_id_,'UserName : '..UserNameID..' .\nMsgs: '..msgs..' .\nStast : '..msg.TheRank..' .\nID : '..msg.sender_user_id_..' .',dl_cb,nil)
		else
...
"أسمي ["..Bot_Name.."] يروحي.",
"أسمي ["..Bot_Name.."] يقلبي.",
"أسمي ["..Bot_Name.."] يحياتي.",
"أسمي ["..Bot_Name.."] م تعرف تقرا؟.",
}
local dr = {
...
‏
  ...
  --=====================================
  elseif Text== "مطور السورس" or Text== "مطور كوين" or Text=="مطور سورس كوين" then
